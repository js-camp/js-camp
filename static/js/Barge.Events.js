...
(function (Bu, Ba, Bo) // don't litter the global scope
{
   ...
   //let's do this change just once and Speed up our stuff :-)
   //init time branching (this func rewrites itself)
   let addEve = null;
